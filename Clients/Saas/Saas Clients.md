...
**Clause:**  
> “Vendor grants the Client a *non-exclusive, non-transferable, revocable license* to use the SaaS Platform for *internal business purposes* only, in accordance with this Agreement.”
...
**Clause:**  
> “Vendor shall make the Platform available with *99.5% uptime* excluding scheduled maintenance, and shall provide *reasonable notice of downtime*.”
...
**Clause:**  
> “If uptime or response times fall below agreed Service Levels, Client shall be entitled to *service credits* as set out in Schedule [SLA].”
...
**Clause:**  
> “All data uploaded by Client or generated through use of the Platform shall remain the *sole property of Client*. Vendor shall not access or use such data except to provide the Services.”
...
## 7. Data Localization (if applicable)

**Clause:**  
> “Vendor shall ensure *storage and processing of regulated data* within India, unless written authorization for cross-border transfer is provided by Client.”
...
**Clause:**  
> “Vendor shall not appoint any subprocessor without *Client’s prior written consent*, and shall ensure that each approved subprocessor is bound by *equivalent data protection obligations*.”
...
**Clause:**  
> “Both Parties shall treat all information disclosed as *Confidential Information* and shall *not disclose, publish, or reproduce* such information except as required by law.”
...
**Clause:**  
> “All rights in the SaaS Platform, software, and documentation remain *exclusive property of Vendor*. Client receives only usage rights as per license terms.”
...
**Clause:**  
> “Vendor shall disclose all *open-source software components* used in the Platform and comply with *applicable OSS licenses*.”
...
**Clause:**  
> “Client may, with reasonable notice, *audit Vendor’s systems and processes* for compliance with data protection and SLA obligations.”
...
**Clause:**  
> “Vendor shall maintain *tested Business Continuity and Disaster Recovery Plans* and shall restore critical services within [24] hours in the event of disruption.”
...
**Clause:**  
> “Vendor warrants that the SaaS Platform shall *perform materially in accordance with specifications* and shall be *free from malicious code*.”
...
## 15. Indemnity (IP & Data Breach)

**Clause:**  
> “Vendor shall indemnify Client against *losses, damages, and claims* arising from *IP infringement, data breaches, or non-compliance with data protection laws*.”
...
**Clause:**  
> “Vendor’s aggregate liability shall not exceed *100% of annual fees paid*, except for *breach of confidentiality, gross negligence, or data protection obligations*.”
...
## 17. Payment Terms & Taxes

**Clause:**  
> “All fees are due within [30] days of invoice. Prices exclude applicable *GST / VAT / withholding taxes*, which shall be borne by Client.”
...
**Clause:**  
> “Vendor may suspend access for *material breach or non-payment* after giving [10] days’ notice. Either Party may terminate for *uncured breach* with [30] days’ notice.”
...
## 19. Data Return & Deletion

**Clause:**  
> “Upon termination, Vendor shall *return or securely delete all Client Data within 30 days*, except where retention is required by law.”
...
**Clause:**  
> “Neither Party shall be liable for delay or failure due to *acts of God, cyberattacks, network failures, or governmental restrictions*.”
...
**Clause:**  
> “Each Party represents that it complies with the *Prevention of Corruption Act, 1988*, *FCPA (US)*, and *UK Bribery Act 2010*.”
...
**Clause:**  
> “Vendor shall comply with *DGFT encryption regulations*, *US EAR/ITAR restrictions*, and *EU Dual-Use Regulation 2021/821*.”
...
**Clause:**  
> “This Agreement shall be governed by the *laws of India* and any dispute shall be resolved by *arbitration under the Arbitration & Conciliation Act, 1996*, seated in [Bangalore / Delhi].”
...
**Clause:**  
> “All notices shall be in writing, delivered by *registered mail or email with acknowledgment*, and deemed served upon receipt.”
...
- **Annexure A:** Service Level Agreement (SLA) & Response Metrics  
- **Annexure B:** Data Protection Addendum (DPA)  
- **Annexure C:** Subprocessor Register  
- **Annexure D:** Business Continuity / Disaster Recovery Plan  
...
*(Cross-Referenced with SaaS-Clients Linked Clause Library)*  
...
|-----------------|--------------|------------------|-------------------|
| Service scope defined as SaaS | Contract Act §2(e) / Directive (EU) 2019/770 | Confirm SaaS model and delivery defined clearly. |   |
| Hosting responsibility clearly assigned | CERT-In 2022 / NIST SP 800-171 | Verify vendor infrastructure scope specified. |   |
...
|-----------------|--------------|------------------|--------|
| License is non-exclusive and non-transferable | Copyright Act §30(1) / UCC §2-312 | Verify language matches statutory requirements. |   |
| Scope limited to internal business use | GDPR Art. 6(1)(b) | Ensure “internal use” limitation exists. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| SLA uptime ≥99% specified | Contract Act §73 / Directive 2019/770 Art. 7 | Review SLA schedule for measurable KPIs. |   |
| Maintenance windows disclosed | FAR 46.202-4 | Confirm notification clause for downtime exists. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Service credits specified | Contract Act §74 | Check formula for pre-agreed liquidated damages. |   |
| SLA breach trigger defined | Directive 2019/770 Art. 7(2) | Confirm objective performance metrics exist. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Client retains ownership of uploaded data | DPDP §10(3) / GDPR Art. 28(3)(g) | Verify explicit ownership clause. |   |
| Vendor use restricted to service provision | DPDP §8(5) / GDPR Art. 6(1)(b) | Confirm no secondary data use allowed. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Security certifications listed (ISO/NIST/SOC2) | CERT-In 2022 / NIST 800-171 | Verify evidence of compliance. |   |
| Encryption and access control measures defined | GDPR Art. 32 | Review DPA / security schedule. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Data residency clause included | DPDP §16 / RBI 2018 / GDPR Art. 46 | Confirm localized storage requirement or waiver. |   |
| Cross-border transfer mechanism stated | GDPR Art. 46 / DPDP §16(3) | Verify SCC / contractual consent mechanism. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Client consent for subprocessor appointment | GDPR Art. 28(2) | Confirm “prior written consent” required. |   |
| Flow-down obligations included | DPDP §10(5) | Review subprocessor DPA template. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Confidentiality clause covers data and business info | IT Act §72 / GDPR Art. 5(1)(f) | Verify inclusion of both data and commercial information. |   |
| Exceptions for legal compliance stated | RTI §8(1)(d) | Check for lawful disclosure carve-out. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Vendor retains ownership of platform IP | Copyright §17(c) / FAR 52.227-14 | Confirm vendor IP retained. |   |
| Client usage rights defined | Directive 2019/770 Art. 3(1) | Verify explicit limited license clause. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| OSS disclosure schedule attached | GPL v3 / DMCA §1201 | Confirm OSS register exists. |   |
| License compliance confirmed | Directive 2019/790 | Verify compliance with attribution & redistribution obligations. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Client right to audit vendor systems | DPDP §10(6) / GDPR Art. 28(3)(h) | Confirm audit clause exists. |   |
| Advance notice and confidentiality provisions | Contract Act §10 | Check audit procedure defined. |   |

---

## 13. Business Continuity & DR  

| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| BCP/DRP implemented and tested | CERT-In / ISO 22301 | Verify annual test reports. |   |
| RTO/RPO metrics defined | NIST 800-34 | Check restoration timeline stated. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Platform performance warranty included | UCC §2-313 / Directive 2019/770 | Verify “material conformity” clause. |   |
| Malicious code warranty present | IT Act §43A | Confirm “free of malware” statement. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| IP infringement indemnity provided | Patents Act §124 / UCC §2-312(3) | Confirm “indemnify, defend, and hold harmless” phrasing. |   |
| Data breach indemnity included | DPDP §33 / GDPR Art. 82 | Verify scope includes data protection violations. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Liability cap defined (≤ annual fees) | Contract Act §74 | Confirm numerical limit stated. |   |
| Data breach exclusions listed | GDPR Art. 82(2) | Ensure breaches exempted from cap. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Payment timeline defined | Contract Act §55 | Verify 30-day payment clause. |   |
| Tax responsibilities allocated | GST Act / VAT Directive | Check for withholding clause. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Suspension for non-payment permitted | Contract Act §39 | Confirm notice period included. |   |
| Termination for uncured breach allowed | Directive 2019/770 Art. 14 | Check 30-day cure period. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Data deletion on termination required | DPDP §10(3) / GDPR Art. 28(3)(g) | Confirm 30-day deletion clause. |   |
| Evidence of deletion (certificate) required | NIST 800-88 | Verify proof-of-deletion protocol exists. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Force majeure clause included | Contract Act §56 / FAR 52.249-14 | Confirm definition includes cyberattacks. |   |
| Notification obligation stated | Directive 2019/770 Art. 14 | Verify time for notice. |   |

---

## 21. Anti-Bribery & Ethics  

| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Compliance with POCA / FCPA / UKBA stated | POCA §§7–9 / FCPA / UKBA 2010 | Verify multi-jurisdiction compliance clause. |   |
| Annual ethics certification required | GFR 144(xi) | Confirm reporting requirement exists. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Export control clause included | DGFT ITC(HS) / EAR 772 / EU Reg 2021/821 | Confirm mention of dual-use software restrictions. |   |
| Encryption export license obtained | MEA / EAR | Verify export documentation maintained. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Governing law expressly chosen | Contract Act §28 / FAA / Brussels I | Verify governing law clause. |   |
| Arbitration clause valid under chosen law | Arbitration Act / ICC Rules | Confirm seat, institution, and language stated. |   |
...
| Compliance Item | Legal Basis | Audit Checkpoint | Status |
|-----------------|--------------|------------------|--------|
| Written notice mechanism included | Contract Act §4–5 / UCC §1-202 | Check valid communication methods listed. |   |
| Effective date of notice defined | CPC §27 | Confirm deemed receipt language included. |   |

---

## Optional Annexures – Verification Checklist  

| Annexure | Content | Verified (✔/✖) |
|-----------|----------|----------------|
| Annexure A | SLA & Uptime Metrics |   |
| Annexure B | Data Protection Addendum (DPA) |   |
| Annexure C | Subprocessor Register |   |
| Annexure D | Business Continuity / DR Plan |   |
| Annexure E | Escrow Agreement |   |
| Annexure F | Compliance Certificates (POCA / FCPA / GDPR) |   |
